...
from app.schemas.user import UserCreate, UserUpdate, UserRegist


class CRUDUser(CRUDBase[User, UserCreate, UserUpdate, UserRegist]):
    ...
    def regist(self, db: Session, *, db_obj: User, obj_in: Union[UserRegist, Dict[str, Any]]) -> User:
